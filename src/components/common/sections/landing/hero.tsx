...
export const Hero = () => {
  return (
    <Container className="mt-24 py-17.5">
      <div className="grid grid-cols-1 lg:grid-cols-2">
        <div className="space-y-9">
          <h1 className="text-black text-43px lg:text-6xl font-medium leading-normal">
          ...
          <Button text="Book a consultation" variant="dark" rounded="2xl" className="w-full lg:w-auto py-5 px-9" />
        </div>
